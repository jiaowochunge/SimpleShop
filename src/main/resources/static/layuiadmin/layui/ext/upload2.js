/**
 ...
 @Change
  1.添加上传进度回调. render时可配置 progress 回调通知
  2. choose before 等回调参数添加 `chooseFiles` 属性，表示选择的文件
 */
...
layui.define('layer' , function(exports){
  ...
  //字符常量
  ,MOD_NAME = 'upload2', ELEM = '.layui-upload', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled'
  ...
  Class.prototype.upload = function(files, type){
    ...
    ,ajaxSend = function(){
      ...
      layui.each(items, function(index, file){
        ...
        //进度
        var progressXhr = function(progressCb) {
          return function() {
            ...
            xhr.upload.addEventListener("progress", function(evt){
              if (evt.lengthComputable) {
                ...
                if (typeof progressCb === 'function') {
                  progressCb(percentComplete, index);
                }
              }
            }, false);
        ...
        $.ajax({
          ...
          ,xhr: progressXhr(options.progress)
